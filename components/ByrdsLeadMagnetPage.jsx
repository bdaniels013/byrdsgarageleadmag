          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="md:hidden flex items-center gap-2 text-xs mt-1">
                <a
                  href="/admin/login"
                  className="flex items-center gap-1 rounded-full bg-gray-700/50 px-2 py-1 text-xs font-medium text-gray-300 hover:bg-gray-600/50 transition-all duration-300 border border-gray-600/50"
                >
          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 md:gap-20 px-4 md:px-8 py-16 md:py-32 md:grid-cols-2">
            <div className="space-y-8 md:space-y-12">
              ...
              <motion.h1
                ...
                >
                  Get a <span className="font-bold text-orange-400 bg-orange-500/20 px-2 py-1 rounded">FREE 90‑point digital inspection</span> with detailed photos and a clear vehicle health score. No pressure, just real data and practical solutions about what your car needs.
                </motion.p>
              </div>
